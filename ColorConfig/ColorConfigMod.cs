...
{
    [BepInPlugin("dusty.colorconfig", "Extended Color Config", "1.2.2")]
    ...
    public class ModOptions : OptionInterface
    {
        ...
        protected void DrawColorPicker(ref OpTab tab, Configurable<Color> config, Vector2 pos)
        {
            OpColorPicker colorPicker = new(config, pos);
            tab.AddItems(colorPicker);
        }
        ...
        public static Configurable<bool> enableSlugcatDisplay, enableVisualisers, removeHSLSliders, enableRGBSliders, enableHSVSliders, 
            enableHexCodeTypers, hsl2HSVOPColorPicker, enableDifferentOpColorPickerHSLPos, enableBetterOPColorPicker;
